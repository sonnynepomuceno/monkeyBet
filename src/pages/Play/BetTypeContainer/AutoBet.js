    ...
    return (
        <div className="auto-bet bet-info">
            ...
            <Toast isOpen={walletModalVisible}
                setIsOpen={setWalletModalVisible}></Toast>
        </div>
    );
}
...
export default connect(mapStateToProps, {
    betRequest, setAutoBet, stopAutoBet, stopBet, setRoundWin,
    showSelectWalletModal, setMaxCredits, changeBetCoin, playBetSoundAction
})(AutoBet)